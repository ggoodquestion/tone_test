...
// Make DSW call
$output = file_get_contents('http://120.126.151.132:8081/slmtk?usage=2&account=' . $account.'&id='.$id);
...
// Get data from DSW
$url = "http://120.126.151.132:8081/slmtk/dsw_get_data.php?usage=2&account=$account&id=$id";
$stream = fopen($url, 'rb');
$content = stream_get_contents($stream);
$fn = $_SERVER['DOCUMENT_ROOT'] . '/slmtk/workspace/' . $workspace . '/' . $account . "_2.zip";
