...
$output = file_get_contents('http://120.126.151.132:8081/slmtk?usage=5&account=' . $account.'&id='.$id, false, stream_context_create($opt));
...
// Get data from DSW
$url = "http://120.126.151.132:8081/slmtk/dsw_get_data.php?usage=5&account=$account&id=$id";
$stream = fopen($url, 'rb');
$content = stream_get_contents($stream);
$fn = $_SERVER['DOCUMENT_ROOT'] . '/slmtk/workspace/' . $workspace . '/' . $account . "_5.zip";
